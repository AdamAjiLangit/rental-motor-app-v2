...
const SimpleButton = ({ text, href }) => {
    return (
        <Link href={href} className="group relative ml-5 inline-block h-[60px] w-[150px] overflow-hidden rounded-full">
